...
public class Principal {
    public static AlunoNegocio alunoNegocio;
    
    public static void main(String [] args){
        try{
            alunoNegocio = new AlunoNegocio();
        }catch (NegocioException ex){
            System.out.println("Camada de negocio e percistencia nao iniciada - "+ ex.getMessage());
        }
    ...
    private static void alterarAluno() throws NegocioException{
        ...
        try{
            ...
            JOptionPane.showMessageDialog(null, "Erro na digitacao"+ ex.getMessage());
        }
    ...
    private static void pesquisaPorNome() throws NegocioException{
    ...
    private static AlunoVO lerDados(AlunoVO alunoTemp){
        ...
        try{
            ...
            nomeMae = JOptionPane.showInputDialog("Forneca nome da mae do Aluno", alunoTemp.getNomeMae().trim());
            alunoTemp.setNomeMae(nomeMae);
            
            nomePai = JOptionPane.showInputDialog("Forneca nome do pai do Aluno", alunoTemp.getNomePai().trim());
            ...
            bairro = JOptionPane.showInputDialog("Forneca o bairro do aluno", alunoTemp.getEndereco().getBairro().trim());
            alunoTemp.getEndereco().setBairro(bairro);
            
            cidade = JOptionPane.showInputDialog("Forneca a cidade do aluno", alunoTemp.getEndereco().getCidade().trim());
            ...
            System.out.println("Erro na digitacao - "+ ex.getMessage());
        }
        return alunoTemp;
    }

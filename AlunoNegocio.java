...
public class AlunoNegocio {
    ...
    public AlunoNegocio() throws NegocioException{
        try{
            ...
            throw new NegocioException("Erro ao iniciar a Persistecia - " + ex.getMessage());
        }
    }
    ...
    public List<AlunoVO> pesquisaParteNome(String parteNome) throws NegocioException{
        try{
            ...
            throw new NegocioException("Erro ao pesquisar o aluno pelo nome - " + ex.getMessage());
        }
    }
    ...
    private String validarDados(AlunoVO alunoVO){
         ...
         if(alunoVO.getEndereco().getNumero() < 1){

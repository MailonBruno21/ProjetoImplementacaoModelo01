...
public class AlunoDAO extends DAO {
    ...
    public AlunoDAO(ConexaoBD conexao) throws PersistenciaException {
        super(conexao);
        try{
            comandoIncluir = conexao.getConexao().prepareStatement("INSERT INTO Aluno ( nome, nomemae, nomepai, sexo, logradouro, numero, bairro, cidade, uf)" 
                    +"VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?)");
            comandoAlterar = conexao.getConexao().prepareStatement("UPDATE Aluno SET nome=?, nomemae=?, nomepai=?, sexo=?, logradouro=?, numero=?, bairro=?, "
                    +"cidade=?, uf=? WHERE matricula=?");
    ...
    public int alterar(AlunoVO alunoVO) throws PersistenciaException {
        ...
        try{
            ...
            throw new PersistenciaException("Erro ao alterar os dados do aluno - "+ ex.getMessage());
        }
        return retorno;
    }
    ...
    public int excluir(int matricula) throws PersistenciaException{
        ...
        try{
            ...
            throw new PersistenciaException("Erro ao excluir o registro do aluno - "+ ex.getMessage());
        }
        return retorno;
    }
    ...
    public AlunoVO buscarPorMatricula(int matricula) throws PersistenciaException{
        ...
        try{
            ...
            throw new PersistenciaException("Erro da busca por codigo - "+ ex.getMessage());
        }
        return alu;
    }
    ...
    public List<AlunoVO> buscarPorNome(String nome) throws PersistenciaException{
        ...
        try{
            try (PreparedStatement comando = conexao.getConexao().prepareStatement(comandoSQL)) {
            ...
            throw new PersistenciaException("Erro na busca pelo nome - "+ ex.getMessage());
        }
        return listaAluno;
    }
    ...
    private AlunoVO montaAlunoVO(ResultSet rs) throws PersistenciaException{
        ...
        if(rs != null){
            try{
                ...
                throw new PersistenciaException("Erro ao acessar os dados - ");
            }
        }
        return alu;
    }
